package com.hyeok.blog.config;

import com.hyeok.blog.config.auth.PrincipalDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // 시큐리티가 대신 로그인을 해주는데 password 를 가로채기할때
    // 해당 password 가 뭘로 해쉬가 되어 회원가입이 되었는지 알아야
    // 같은 해쉬로 암호화해서 DB 에 있는 해쉬랑 비교할 수 있다.
    @Override
